 ...
 * @example
 * ```typescript
 * import { TenantResolver, ResolverPriority } from "@abdokouta/react-multitenancy";
 *
 ...
 * @example
 * ```typescript
 * // Custom resolver with caching using @abdokouta/react-cache
 * import { TTLCache } from "@abdokouta/react-cache";
 *
