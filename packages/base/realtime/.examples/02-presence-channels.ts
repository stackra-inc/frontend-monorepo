...
import { RealtimeModule, RealtimeManager, REALTIME_MANAGER } from '@stackra/ts-realtime';
...
function memberTracking() {
  ...
  */
  ...
  console.log('      const current = presence.getMembers<User>();');
  console.log('      console.log(`${member.name} joined. Total: ${current.length}`);');
  console.log('    })');
  console.log('    .leaving<User>((member) => {');
  console.log('      // Departed member is already removed');
  console.log('      const current = presence.getMembers<User>();');
  console.log('      console.log(`${member.name} left. Total: ${current.length}`);');
  console.log('    });');
  console.log('');
