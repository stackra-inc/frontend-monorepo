/**
 * @fileoverview ESLint configuration for @stackra/ts-cache package
 *
...
const config: Linter.Config[] = [
  ...
  {
    rules: {
      // Disable turbo rules — this is a standalone package, not a monorepo.
      'turbo/no-undeclared-env-vars': 'off',
      // Cache APIs use `any` for generic value storage — this is intentional.
