...
function platformClientInjection() {
  ...
  */
  ...
  console.log(
    "  // Echo uses the injected client instead of importing pusher-js.",
  );
  console.log("");
...
function refCounting() {
  ...
  */
  ...
  console.log(
    '    const { data } = useChannel<OrderEvent>("orders", ".order.created");',
  );
  ...
  console.log(
    '    // Also subscribes to "orders" channel — shares the wrapper',
  );
  console.log(
    '    const { data } = useChannel<OrderEvent>("orders", ".order.created");',
  );
...
function featureComparison() {
  ...
  console.log(
    "  │ Event listening      │ ✓ Yes    │ ✓ Yes    │ ✓ Yes        │",
  );
  console.log(
    "  │ Member tracking      │ ✗ No     │ ✗ No     │ ✓ Yes        │",
  );
  console.log(
    "  │ here() callback      │ ✗ No     │ ✗ No     │ ✓ Yes        │",
  );
  console.log(
    "  │ joining() callback   │ ✗ No     │ ✗ No     │ ✓ Yes        │",
  );
  console.log(
    "  │ leaving() callback   │ ✗ No     │ ✗ No     │ ✓ Yes        │",
  );
  console.log(
    "  │ Error callbacks      │ ✓ Yes    │ ✓ Yes    │ ✓ Yes        │",
  );
  console.log(
    "  │ Auto re-subscribe    │ ✓ Yes    │ ✓ Yes    │ ✓ Yes        │",
  );
  console.log(
    "  │ Method               │ channel  │ private  │ join         │",
  );
  console.log(
    "  │ React hook           │ useChannel│useChannel│ usePresence │",
  );
  console.log(
    "  │ Use case             │ Global   │ User     │ Collaboration│",
  );
  console.log(
    "  └──────────────────────┴──────────┴──────────┴──────────────┘",
  );
