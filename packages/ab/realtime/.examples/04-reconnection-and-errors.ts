...
function statusTransitions() {
  ...
  */
  ...
  console.log(
    "    console.log(`  Reconnect attempts: ${manager.reconnectAttempts}`);",
  );
  console.log("  });");
  console.log("");
...
function autoResubscription() {
  ...
  */
  ...
  console.log(
    '  userChannel.listen<Notification>(".notification", handleNotif);',
  );
  ...
  console.log(
    "  //   2. Your callbacks (handleOrder, handleNotif, handleMembers)",
  );
  console.log("  //      continue to work without any changes");
  console.log(
    "  //   3. Presence channel fires here() again with current members",
  );
  console.log("");
