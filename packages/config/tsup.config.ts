/**
 * @fileoverview tsup build configuration for @abdokouta/ts-config
 *
...
export default {
  ...
  // Separate entry for the Vite plugin so consumers can import from '@abdokouta/ts-config/vite-plugin'
